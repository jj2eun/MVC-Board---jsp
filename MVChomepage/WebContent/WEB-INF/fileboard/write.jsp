...
<body>
	<form action="${root}/fileboard/writeOk.do" id="createform" name="createform" method="post" 
	enctype="multipart/form-data" onsubmit="return boardCheck(this)">
		<div id="title"><a href="${root}/fileboard/list.do">글 목록</a></div>
