...
<body>
	<div id="createform">
		...
		<c:if test="${boardDto.fileName != null}">
			<div class="menu" style="border-bottom-width: 0px;">
				<div id="id">파일명</div>
				<img alt="${boardDto.fileName }" src="../pds/1616485188584_image2.jpg">
			</div>
		</c:if>
		<div class="menu" style="border-bottom-width: 3px; text-align: center;">
			...
			<input type="button" value="글 목록" onclick="location.href='${root}/fileboard/list.do?pageNumber=${pageNumber}'">
		</div>
	</div>
</body>
</html>